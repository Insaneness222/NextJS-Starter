...
export const i18n = {
  ...
  ko: {
    ...
    poc: {
      ...
      objectives: {
        title: 'PoC 목표',
        content: '세 가지 플랫폼 유형에 대한 자동 위치 선택의 타당성을 입증합니다: 명확한 사격 경로가 필요한 자주포 유닛, 차체 은폐 방어 위치가 필요한 전차 유닛, 기동성과 은폐에 최적화된 UGV 유닛. 각 플랫폼 유형에는 사용자 정의 가능한 가중치 매개변수에 반영된 고유한 전술적 요구사항이 있습니다.',
        badge: '시뮬레이터에서 구현됨',
      },
      approach: {
        title: '솔루션 접근법',
